    ...
    protected void processMouseEvent(MouseEvent mouseEvent) {
        ...
        if (mouseEvent.getButton() == MouseEvent.BUTTON1) {
            ...
            if (field[i][j] == FIELD_EMPTY) {
                ...
                if (res!=0){
                    if (res == FIELD_0*3) {
                        JOptionPane.showMessageDialog(this, "0 WON!", "WIN!", JOptionPane.INFORMATION_MESSAGE);
                    } else if (res == FIELD_X*3) {
                        JOptionPane.showMessageDialog(this, "X WON!", "WIN!", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(this, "Dead Heat! Try again", "Dead Heat!", JOptionPane.INFORMATION_MESSAGE);
                    }
                    initGame();
                    repaint();
                }
